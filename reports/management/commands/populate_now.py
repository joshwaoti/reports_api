    ...
    def handle(self, *args, **kwargs):
        ...
        for _ in range(100):
            p2p_switch_info.objects.create(
                reporting_date="21-Oct-2024",
                bank_id=faker.lexify(text='?????'),
                transcation_channel=faker.word(),
        ...
        for _ in range(100):
            psp_products_info.objects.create(
                ...
                product_partner_name=faker.company(),
        ...
        for _ in range(100):
            trustaccount_data.objects.create(
                ...
                bank_account_number=faker.random_int(min=1000000000, max=9999999999),
        ...
        for _ in range(100):
            FailedRejectedTrxInfo.objects.create(
                psp_id=random.choice([choice[0] for choice in PSP_ID_OTHER_CHOICES]),
                bank_id=random.choice([choice[0] for choice in BANK_ID_CHOICES]),
        ...
        for _ in range(100):
            PaymentGatewayTransactionsTarrifs.objects.create(
                reporting_date=faker.date_this_year(),
                psp_id=random.choice([choice[0] for choice in PSP_ID_OTHER_CHOICES]),
                channel_used=faker.word(),
                channel_partner_name=faker.company(),
                charge_description=faker.sentence(nb_words=3),
        ...
        for _ in range(100):
            PaymentGatewayTransactionsDetails.objects.create(
                reporting_date=faker.date_this_year(),
                psp_id=random.choice([choice[0] for choice in PSP_ID_OTHER_CHOICES]),
                card_brand_type=random.choice([choice[0] for choice in CARD_BRAND_TYPE_CHOICES]),
                card_type=random.choice([choice[0] for choice in CARD_TYPE_CHOICES]),
        ...
        for _ in range(100):
            PaymentGatewayBillingTemplate.objects.create(
                reporting_date=faker.date_this_year(),
                psp_id=random.choice([choice[0] for choice in PSP_ID_OTHER_CHOICES]),
        ...
        for _ in range(100):
            paymentGatewayCardBrands.objects.create(
                reporting_date=faker.date_this_year(),
                psp_id=random.choice([choice[0] for choice in PSP_ID_OTHER_CHOICES]),
                bank_id=random.choice([choice[0] for choice in BANK_ID_CHOICES]),
                card_flag=random.choice([choice[0] for choice in CARD_FLAG_CHOICES]),
