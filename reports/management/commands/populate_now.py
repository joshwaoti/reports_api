    ...
    def handle(self, *args, **kwargs):
        ...
        for _ in range(100):
            psp_agents_info.objects.create(
                ...
                volume_cash_out_at_agents=faker.random_int(min=1, max=10000),
                value_cash_out_at_agents=faker.pydecimal(left_digits=10, right_digits=2, positive=True),
                amount_e_float_mobile_agents=faker.pydecimal(left_digits=10, right_digits=2, positive=True),
                number_agent_cash_dep_banks=faker.random_int(min=1, max=10000),
                value_agent_cash_dep_banks=faker.pydecimal(left_digits=10, right_digits=2, positive=True),
                no_agent_cash_withd_banks=faker.random_int(min=1, max=10000),
                value_agent_cash_withd_banks=faker.pydecimal(left_digits=10, right_digits=2, positive=True),
            )
        ...
        for _ in range(100):
            psp_tariffs_info.objects.create(
                ...
                p2p_off_net_reg_wallet=faker.random_int(min=1, max=1000),
                p2p_off_net_non_reg_wallet=faker.random_int(min=1, max=1000),
                cash_withdrawal_mob_money_agent=faker.random_int(min=1, max=1000),
                cash_withdrawals_bank_atms=faker.random_int(min=1, max=1000),
                agent_com_cash_out_reg_cust=faker.random_int(min=1, max=1000),
                agent_com_cash_out_unreg_cust=faker.random_int(min=1, max=1000),
                agents_commission_for_cash_in=faker.random_int(min=1, max=1000),
                atm_commission_for_cash_out=faker.random_int(min=1, max=1000),
                atm_commission_for_cash_in=faker.random_int(min=1, max=1000),
                b2c_pay_bill_type_1_customer=faker.random_int(min=1, max=1000),
                b2c_payment_pbill_type_2_cust=faker.random_int(min=1, max=1000),
                b2c_payment_pbill_type_2_bus=faker.random_int(min=1, max=1000),
                b2c_payment_pbill_type_3_bus=faker.random_int(min=1, max=1000),
                c2b_pay_bill_type_1_customer=faker.random_int(min=1, max=1000),
                c2b_payment_pbill_type_2_cust=faker.random_int(min=1, max=1000),
                c2b_payment_pbill_type_2_bus=faker.random_int(min=1, max=1000),
                c2b_payment_pbill_type_3_bus=faker.random_int(min=1, max=1000),
                b2b_pay_bill_type_1_customer=faker.random_int(min=1, max=1000),
                b2b_payment_pbill_type_2_cust=faker.random_int(min=1, max=1000),
                b2b_payment_p_bill_type_2_bus=faker.random_int(min=1, max=1000),
                b2b_payment_pay_bill_type_3=faker.random_int(min=1, max=1000),
                b2c_payment_bank_aggreg_code=faker.random_int(min=1, max=1000),
                c2b_payment_bank_aggreg_code=faker.random_int(min=1, max=1000),
        ...
        for _ in range(100):
            failed_txn_data.objects.create(
                ...
                volume_of_transactions=faker.random_int(min=1, max=10000),
                value_of_transactions=faker.pydecimal(left_digits=10, right_digits=2, positive=True),
                percentage_of_failed_txns=faker.random_int(min=1, max=100)
            )
        ...
        for _ in range(100):
            new_mobile_agents.objects.create(
                ...
                date_of_onboarding=faker.date_between(start_date='-2y', end_date='today').strftime('%d-%b-%Y'),
                ...
                suspension_termination_date=faker.date_between(start_date='-1y', end_date='today').strftime('%d-%b-%Y'),
        ...
        for _ in range(100):
            counterfeit_transactions.objects.create(
                ...
                date_confiscated=faker.date_between(start_date='-1y', end_date='today').strftime('%d-%b-%Y'),
        ...
        for _ in range(100):
            trustaccount_data.objects.create(
                ...
                org_receiving_donation=faker.company(),
                sector_code=random.choice([choice[0] for choice in SECTOR_CODE_CHOICES]),
                trust_acc_int_utilized_details=random.choice([choice[0] for choice in TRUST_ACCOUNT_UTILIZED_DETAILS_CHOICES]),
        ...
        for _ in range(100):
            system_activity_info.objects.create(
                ...
                no_of_transactions_per_hour=faker.random_int(min=1, max=10000)
            )
        ...
        for _ in range(100):
            psp_customer_complaints.objects.create(
                ...
                complainant_contact_number=faker.random_int(min=1, max=1000000),
        ...
        for _ in range(100):
            sch_sy_stabil_srvce_int.objects.create(
                ...
                third_party_name=faker.company()[:20],
                product_type=random.choice([choice[0] for choice in PRODUCT_TYPE_CHOICES]),
                system_unavailability_type_cod=random.choice([choice[0] for choice in SYSTEM_UNAVAILABILITY_CHOICES]),
                third_party_system_affected=faker.sentence(),
                service_interruption_cause_cod=random.choice([choice[0] for choice in INTERRUPTION_CODE_CHOICES]),
        ...
        for _ in range(100):
            psp_cybersecurity_incident_record.objects.create(
                ...
                date_and_time_of_incident_happened=faker.date_time_this_year().strftime('%d-%b-%y %I.%M.%S.%f'),
                ...
                date_and_time_of_the_incident_resolution=faker.date_time_this_year().strftime('%d-%b-%y %I.%M.%S.%f'),
        ...
        for _ in range(100):
            sched_of_dir.objects.create(
                ...
                date_of_appointment=faker.date_between(start_date='-5y', end_date='today').strftime('%d-%b-%Y'),
                date_of_retirement=faker.date_between(start_date='today', end_date='+10y').strftime('%d-%b-%Y'),
        ...
        for _ in range(100):
            senior_mngt_schedule.objects.create(
                ...
                date_of_emp=faker.date_between(start_date='-10y', end_date='today').strftime('%d-%b-%Y'),
                retirement_date=faker.date_between(start_date='today', end_date='+15y').strftime('%d-%b-%Y'),
        ...
        for _ in range(100):
            sched_of_share_hldrs.objects.create(
                ...
                dob_or_reg_date=faker.date_of_birth(minimum_age=18, maximum_age=80).strftime('%d-%b-%Y'),
                nationality=random.choice([choice[0] for choice in COUNTRY_CODE_CHOICES]),
                resident_country=random.choice([choice[0] for choice in COUNTRY_CODE_CHOICES]),
                id_no_passport=faker.lexify(text='????????'),
                pin=faker.lexify(text='??????'),
                ...
                onboarding_date=faker.date_between(start_date='-5y', end_date='today').strftime('%d-%b-%Y'),
        ...
        for _ in range(100):
            sched_of_trustees.objects.create(
                ...
                dob=faker.date_of_birth(minimum_age=30, maximum_age=70).strftime('%d-%b-%Y'),
                nationality=random.choice([choice[0] for choice in COUNTRY_CODE_CHOICES]),
                resident_country=random.choice([choice[0] for choice in COUNTRY_CODE_CHOICES]),
                id_no_passport=faker.lexify(text='????????'),
                pin=faker.lexify(text='??????'),
        ...
        for _ in range(100):
            merchant_transaction_info.objects.create(
                ...
                merchant_classification_code=random.choice([choice[0] for choice in MERCHANT_CLASSIFICATION_CODE_CHOICES]),
                sub_county_code=random.choice([choice[0] for choice in SUB_COUNTY_CHOICES]),
                merchant_status=random.choice([choice[0] for choice in MERCHANT_STATUS_CHOICES]),
                band_code=random.choice([choice[0] for choice in BAND_CHOICES]),
