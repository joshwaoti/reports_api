...
class trust_account_info(models.Model):
    ...
    psp_id = models.CharField(max_length=25, choices=PSP_ID_OTHER_CHOICES)
    reporting_date = models.CharField(max_length=20)
    trust_fund_placement = models.CharField(max_length=25, choices=TRUST_ACCOUNT_DETAILS_CHOICES)
    trust_fund_inv_maturity_date = models.CharField(max_length=25)
...
class psp_tariffs_info(models.Model):
    ...
    agent_com_cash_out_unreg_cust = models.PositiveIntegerField()
    agents_commission_for_cash_in = models.PositiveIntegerField()
    atm_commission_for_cash_out = models.PositiveIntegerField()
    atm_commission_for_cash_in = models.PositiveIntegerField()
    b2c_pay_bill_type_1_customer = models.PositiveIntegerField()
    b2c_payment_pbill_type_2_cust = models.PositiveIntegerField()
    b2c_payment_pbill_type_2_bus = models.PositiveIntegerField()
    b2c_payment_pbill_type_3_bus = models.PositiveIntegerField()
    c2b_pay_bill_type_1_customer = models.PositiveIntegerField()
    c2b_payment_pbill_type_2_cust = models.PositiveIntegerField()
    c2b_payment_pbill_type_2_bus = models.PositiveIntegerField()
    c2b_payment_pbill_type_3_bus = models.PositiveIntegerField()
    b2b_pay_bill_type_1_customer = models.PositiveIntegerField()
    b2b_payment_pbill_type_2_cust = models.PositiveIntegerField()
    b2b_payment_p_bill_type_2_bus = models.PositiveIntegerField()
    b2b_payment_pay_bill_type_3 = models.PositiveIntegerField()
    b2c_payment_bank_aggreg_code = models.PositiveIntegerField()
    c2b_payment_bank_aggreg_code = models.PositiveIntegerField()
...
class merchant_transaction_info(models.Model):
    ...
    merchant_classification_code = models.CharField(max_length=10, choices=MERCHANT_CLASSIFICATION_CODE_CHOICES)
    sub_county_code = models.CharField(max_length=4, choices=SUB_COUNTY_CHOICES)
    merchant_status = models.CharField(max_length=25, choices=MERCHANT_STATUS_CHOICES)
    band_code = models.CharField(max_length=25, choices=BAND_CHOICES)
...
class failed_txn_data(models.Model):
    ...
    volume_of_transactions = models.PositiveIntegerField()
    value_of_transactions = models.DecimalField(max_digits=12, decimal_places=2)
    percentage_of_failed_txns = models.PositiveIntegerField()
...
class new_mobile_agents(models.Model):
    ...
    date_of_onboarding=models.CharField(max_length=20)
    ...
    suspension_termination_date=models.CharField(max_length=20)
...
class counterfeit_transactions(models.Model):
    ...
    date_confiscated=models.CharField(max_length=15)
...
class wallet_to_wallet(models.Model):
    ...
    business_size_code=models.CharField(max_length=10, choices=BUSINESS_SIZE_CODE_CHOICES)
    volume_of_transactions=models.PositiveIntegerField()
    value_of_transactions=models.DecimalField(max_digits=12, decimal_places=2)
...
class pymt_gw_card_brands(models.Model):
    ...
    reporting_date = models.CharField(max_length=20)
    psp_id = models.CharField(max_length=25, choices=PSP_ID_OTHER_CHOICES)
    bank_id = models.CharField(max_length=25, choices=BANK_ID_CHOICES)
...
class incidents_data(models.Model): # not in GDI User Guide phase 2
    ...
    sub_county_code = models.CharField(max_length=6, choices=SUB_COUNTY_CHOICES)
    sub_fraud_code = models.CharField(max_length=10, choices=SUB_FRAUD_FRAUD_CHOICES)
    fraud_category_flag = models.CharField(max_length=10, choices=FRAUD_CATEGORY_FLAG_CHOICES)
    ...
    date_of_occurence = models.CharField(max_length=15)
...
class system_activity_info(models.Model): # not in GDI User Guide phase 2
    ...
    reporting_date = models.CharField(max_length=20)
    psp_id = models.CharField(max_length=25, choices=PSP_ID_OTHER_CHOICES)
    hour_of_the_day = models.CharField(max_length=10, choices=TIME_CHOICES)
    no_of_transactions_per_sec = models.PositiveIntegerField()
    no_of_transactions_per_hour = models.PositiveIntegerField()
...
class psp_customer_complaints(models.Model):
    ...
    agent_id = models.CharField(max_length=10)
    date_of_occurence = models.CharField(max_length=15)
    date_reported_to_the_institution = models.CharField(max_length=15)
    date_resolved = models.CharField(max_length=15)
...
class sch_sy_stabil_srvce_int(models.Model):
    ...
    third_party_name = models.CharField(max_length=25)
    product_type = models.CharField(max_length=100,choices=PRODUCT_TYPE_CHOICES)
    system_unavailability_type_cod = models.CharField(max_length=100,choices=SYSTEM_UNAVAILABILITY_CHOICES)
    third_party_system_affected = models.CharField(max_length=100)
    service_interruption_cause_cod = models.CharField(max_length=100,choices=INTERRUPTION_CODE_CHOICES)
...
class psp_cybersecurity_incident_record(models.Model):
    ...
    date_and_time_of_incident_happened =models.CharField(max_length=50) # DDMMYYYYHH:MM:SS
    ...
    date_and_time_of_the_incident_resolution =models.CharField(max_length=50) # DDMMYYYYHH:MM:SS
...
class sched_of_dir(models.Model):  # Psp schedule of directors
    ...
    date_of_retirement = models.CharField(max_length=15)
...
class senior_mngt_schedule(models.Model): #psp schedule of senior management
    ...
    date_of_emp = models.CharField(max_length=15)
    retirement_date = models.CharField(max_length=15)
...
class sched_of_share_hldrs(models.Model): #psp schedule of share holders
    ...
    dob_or_reg_date= models.CharField(max_length=15)
    nationality = models.CharField(max_length=10,choices=COUNTRY_CODE_CHOICES)
    resident_country = models.CharField(max_length=10,choices=COUNTRY_CODE_CHOICES)
    id_no_passport = models.CharField(max_length=10)
    pin = models.CharField(max_length=10)
    ...
    onboarding_date = models.CharField(max_length=15)
